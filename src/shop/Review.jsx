                    ...
                    <div className='post-item'>
                        ...
                        <div className='post-content'>
                            <ul className='lab-ul'>
                                ...
                                <li>sit amet, consectetur adipiscing elit, sed do eiusmod tempor</li>
                                <li>amet, consectetur adipiscing elit, sed do eiusmod tempor</li>
                                <li>consectetur adipiscing elit, sed do eiusmod tempor</li>
                                <li>ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor</li>
                                <li>Lorem sit amet, consectetur adipiscing elit, sed do eiusmod tempor</li>
                                <li>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor</li>
                            </ul>
                        </div>
                    </div>
